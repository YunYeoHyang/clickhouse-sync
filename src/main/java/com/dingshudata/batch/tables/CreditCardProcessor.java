...
@StepScope
@Service
public class CreditCardProcessor implements ItemProcessor<CreditCard, LinkedHashMap<String, Object>> {

    @Override
    public LinkedHashMap<String, Object> process(CreditCard item) {
